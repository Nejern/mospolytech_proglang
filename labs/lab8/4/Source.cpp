...
void setAngleA(float a, float m) { this->a.setAngle(a); this->a.setMinutes(m); }
void setAngleB(float a, float m) { this->b.setAngle(a); this->b.setMinutes(m); }
void setAngleC(float a, float m) { this->c.setAngle(a); this->c.setMinutes(m); }
