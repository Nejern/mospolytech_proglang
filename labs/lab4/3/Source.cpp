...
int main() {
  ...
  airports[0] = Airport{
      "SU1110", "UUEE", "URSS", "A320", 158,
  };
  airports[1] = Airport{
      "SU1522", "UUEE", "USMU", "A320", 158,
  };
  airports[2] = Airport{
      "SU1304", "UUEE", "URMM", "A321", 236,
  };
  airports[3] = Airport{
      "SU1134", "UUEE", "URSS", "A350", 316,
  };
  airports[4] = Airport{
      "SU006", "UUEE", "ULLI", "A321", 236,
  };
  ...
  while (command != 0) {
    ...
    case 1: {
      airports =
          (Airport *)realloc(airports, sizeof(Airport) * (airports_size + 1));
    ...
    case 2: {
      ...
      for (int i = 0; i < airports_size; ++i) {
        if (strcmp(airports[i].plane_type, tmp_plane_type) == 0) {
          tmp_ans_arr = (char **)realloc(
              tmp_ans_arr, sizeof(char *) * (tmp_ans_arr_size + 1));
          tmp_ans_arr[tmp_ans_arr_size] =
              (char *)malloc(sizeof(char) * (SIZE * 3 + 2));
          snprintf(tmp_ans_arr[tmp_ans_arr_size], sizeof(char) * (SIZE * 3 + 2),
                   "%s: %s", airports[i].arrival_name,
